...
public class MainActivity extends Activity {
    ...
    boolean data = false;
    int score, obstacles, enemies1, enemies2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent i = getIntent();
       data = i.getBooleanExtra("custom game", false);
       obstacles = i.getIntExtra("obstacles", 0);
       score = i.getIntExtra("score", 0);
       enemies1 = i.getIntExtra("blackEnemies", 0);
       enemies2 = i.getIntExtra("pinkEnemies", 0);
    ...
    private void startGame(GameView gView, GameThread gThread, Bundle savedInstanceState) {
        ...
        mGameThread = new TheGame(mGameView, MainActivity.this);
        mGameView.setThread(mGameThread);
        mGameThread.setState(GameThread.STATE_READY);
        mGameView.startSensor((SensorManager)getSystemService(Context.SENSOR_SERVICE));
        if (data==true){
            mGameThread.customLevel =true;
            mGameThread.custScore = score;
            mGameThread.custObstacle = obstacles;
            mGameThread.custEnemyB = enemies1;
            mGameThread.custEnemyP = enemies2;
        }
    }
